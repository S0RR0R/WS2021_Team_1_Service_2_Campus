...
public class rooms {
    ...
    public static void createRoomSuccess() {
        ...
        System.out.println("Success! A new room with the address "+roomAddressName+" ,and the name:"+roomCategoryHolder+" has been created. It belongs to the faculty:"+facultyHolder);
    }
    ...
    public static void main(String[] args) {
        ...
        roomAddress[houseNumber][roomFloor][roomNumber] = roomCategory;
        ...
        if (roomAddress[houseNumber][roomFloor][roomNumber] == null) {                                                           //check if this part of the array already has values
            ...
            createRoomSuccess();   //notification of success
        }
        else {System.out.print("The room you are trying to create does already exists. Please restart the process and try again.");}    //error notification
    }}